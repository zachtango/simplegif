 ...
 */
const corePath = typeof process !== 'undefined' && "production" === 'development'
  ? new URL('/node_modules/@ffmpeg/core/dist/ffmpeg-core.js', import.meta.url).href
  : `https://unpkg.com/@ffmpeg/core@${require$$2.devDependencies['@ffmpeg/core'].substring(1)}/dist/ffmpeg-core.js`;

var defaultOptions = { corePath };
...
const { version: version$2 } = require$$2;
...
var createFFmpeg = (_options = {}) => {
  ...
  log('info', `use ffmpeg.wasm v${version$2}`);
...
export { createFFmpeg$1 as createFFmpeg };
