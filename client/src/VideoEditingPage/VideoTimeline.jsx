...
const VideoTimeline = ({
  ...
  function onMouseMove(e, side) {
    ...
    const rightBound =
      timelineRef.current.offsetLeft + timelineRef.current.clientWidth;
    ...
    if (side == SIDE.LEFT) {
      ...
      if (e.clientX >= rightBound - right - 4 * TRIM_SELECTOR_WIDTH_PX) return;
      ...
      const VIDEO_DURATION_MILLISECONDS =
        videoDuration * MILLISECONDS_PER_SECOND;
      ...
      videoRef.current.currentTime =
        (newLeft * MILLISECONDS_PER_PIXEL) / MILLISECONDS_PER_SECOND;
      ...
      if (e.clientX <= leftBound + left + 3 * TRIM_SELECTOR_WIDTH_PX) return;
