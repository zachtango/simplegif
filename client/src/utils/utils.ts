...
import { MILLISECONDS_PER_HOUR, MILLISECONDS_PER_MINUTE, MILLISECONDS_PER_SECOND, RESOLUTION_TO_FFMPEG_ARG, TIMELINE_WIDTH, TRIM_SELECTOR_WIDTH_PX } from "./constants";
...
export async function saveGif(
    ...
    const end = (TIMELINE_WIDTH - right - TRIM_SELECTOR_WIDTH_PX) * MILLISECONDS_PER_PIXEL
