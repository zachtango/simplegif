  ...
  return (
    <div class='w-full h-full flex justify-center'>
      <div class='my-[50px] h-4/6 min-h-[500px] flex flex-col items-center justify-center'>
        ...
        >
          <video class='max-h-full min-h-full' autoPlay ref={videoRef} />
        </div>
        ...
        {isLoaded && mediaRecorder && (
          <div class='my-[14px] flex flex-col items-center justify-evenly'>
            ...
            >
              {/* Stop Recording Text */}
              <div class='ml-2 tracking-wider'>Stop Recording</div>

              {/* Stop Recording Icon */}
              <div class='flex h-6 w-6 content-center items-center rounded-md bg-white shadow-md'></div>
            </button>
          </div>
        )}

        {!isLoaded && (
          <button class='rounded-md bg-green-600 p-2 text-white' onClick={load}>
